...
batch_size=250
#eğitim
hist=model.fit(x_train,y_train,batch_size,validation_data=(x_validation,y_validation),epochs=50,steps_per_epoch=x_train.shape[0]//batch_size,shuffle=1)
